...
//     contextMenu.style.display = 'none';
// }// Select all location containers
var locationContainers = document.querySelectorAll('.location-container');

// Loop through each container and attach event listener
locationContainers.forEach(function(container) {
    container.addEventListener('click', function() {
        // Toggle the dropdown menu within the clicked container
        var dropdownMenu = this.querySelector('.dropdown-menu');
        dropdownMenu.style.display = dropdownMenu.style.display === 'block' ? 'none' : 'block';
    });
});

// Close the dropdowns if the user clicks outside any of them
